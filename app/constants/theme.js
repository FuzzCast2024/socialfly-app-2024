...
export const IMAGES = {
	...
	sbgImage : require('../assets/images/background/pic1.jpg'), 
	profileLayout1 : require('../assets/images/profile/layout1.png'),
	profileLayout2 : require('../assets/images/profile/layout2.png'),
	profileLayout3 : require('../assets/images/profile/layout3.png'),
	profileLayout4 : require('../assets/images/profile/layout4.png'),
	// social app images end
	
	//grocery app images start
	catFruits : require('../assets/images/category/fruits.png'),
	catVegetables : require('../assets/images/category/vegetables.png'),
	catSpices : require('../assets/images/category/spices.png'),
	catMeat : require('../assets/images/category/meat.png'),
	pomegranate : require('../assets/images/item/pomegranate.png'),
	orange : require('../assets/images/item/orange.png'),
	cauliflower : require('../assets/images/item/cauliflower.png'),
	leaf : require('../assets/images/item/leaf.png'),
	beef : require('../assets/images/item/beef.png'),
	strawberry : require('../assets/images/item/strawberry.png'),
	grCat1 : require('../assets/images/category/pic1.png'),
	grCat2 : require('../assets/images/category/pic2.png'),
	grCat3 : require('../assets/images/category/pic3.png'),
	grCat4 : require('../assets/images/category/pic4.png'),
	grCat5 : require('../assets/images/category/pic5.png'),
	grBanner1 : require('../assets/images/banner/pic1.png'),
	grBanner2 : require('../assets/images/banner/pic2.png'),
	//grocery app images end
	
	//food app images start
	foodPattern1 : require('../assets/images/pattern/pattern1.png'),
	foodPattern2 : require('../assets/images/pattern/patterndark1.png'),
	foodPattern3 : require('../assets/images/pattern/pattern3.png'),
	...
	foodDetailImg : require('../assets/images/items/big/pic1.png'),
	...
	eduPattern1 : require('../assets/images/pattern/pattern1.png'),
	eduPattern2 : require('../assets/images/pattern/pattern2.png'),
	eduPattern3 : require('../assets/images/pattern/pattern3.png'),
	eduBnr1 : require('../assets/images/pic1.png'),
	eduBnr2 : require('../assets/images/pic2.png'),
	eduCourse1 : require('../assets/images/course/pic1.png'),
	eduPic1 : require('../assets/images/course/small/pic1.png'),
	eduPic2 : require('../assets/images/course/small/pic2.png'),
	eduPic3 : require('../assets/images/course/small/pic3.png'),
	eduPic4 : require('../assets/images/course/small/pic4.png'),
	eduPic5 : require('../assets/images/course/small/pic5.png'),
	flyMan : require('../assets/images/flyMan.png'),
	//education app images end
	
	//dating app images start
	datingPic1 : require('../assets/images/cards/pic1.png'), 
	datingPic2 : require('../assets/images/cards/pic2.png'), 
	datingPic3 : require('../assets/images/cards/pic3.png'), 
	datingPic4 : require('../assets/images/cards/pic4.png'), 
	datingPic5 : require('../assets/images/cards/pic5.png'), 
	datingLike1 : require('../assets/images/liked/pic1.png'), 
	datingLike2 : require('../assets/images/liked/pic2.png'), 
	datingLike3 : require('../assets/images/liked/pic3.png'), 
	datingLike4 : require('../assets/images/liked/pic4.png'), 
	datingLike5 : require('../assets/images/liked/pic5.png'), 
	datingLike6 : require('../assets/images/liked/pic6.png'), 
	datingPattern1 : require('../assets/images/pattern/pattern1.png'), 
	...
	cfItem1 : require('../assets/images/item/pic1.png'), 
	cfItem2 : require('../assets/images/item/pic2.png'), 
	cfItem3 : require('../assets/images/item/pic3.png'), 
	cfItem4 : require('../assets/images/item/pic4.png'), 
	cfItem5 : require('../assets/images/item/pic5.png'), 
	cfItem6 : require('../assets/images/item/pic6.png'), 
	cfItem7 : require('../assets/images/item/pic7.png'), 
	cfItem8 : require('../assets/images/item/pic8.png'), 
	cfItem9 : require('../assets/images/item/pic9.png'), 
	cfItem10 : require('../assets/images/item/pic10.png'), 
	cfDetail1 : require('../assets/images/item/detail/pic1.png'), 
	cfDetail2 : require('../assets/images/item/detail/pic2.png'), 
	cfDetail3 : require('../assets/images/item/detail/pic3.png'), 
	cfDetail4 : require('../assets/images/item/detail/pic4.png'), 
	cfDetail5 : require('../assets/images/item/detail/pic5.png'), 
	car : require('../assets/images/categories/car.png'), 
	building : require('../assets/images/categories/building.png'), 
	iphone : require('../assets/images/categories/iphone.png'), 
	suitcase : require('../assets/images/categories/suitcase.png'), 
	motorbike : require('../assets/images/categories/motorbike.png'), 
	desktop : require('../assets/images/categories/desktop.png'), 
	furniture : require('../assets/images/categories/furniture.png'), 
	dress : require('../assets/images/categories/dress.png'), 
	cfPattern1 : require('../assets/images/pattern/pattern1.png'), 
	//classified app images end
	
	//blog app images start
	blog1 : require('../assets/images/blog/pic1.png'), 
	blog2 : require('../assets/images/blog/pic2.png'), 
	blog3 : require('../assets/images/blog/pic3.png'), 
	blogSmall1 : require('../assets/images/blog/small/pic1.png'), 
	blogSmall2 : require('../assets/images/blog/small/pic2.png'), 
	blogSmall3 : require('../assets/images/blog/small/pic3.png'), 
	blogSmall4 : require('../assets/images/blog/small/pic4.png'), 
	blogSmall5 : require('../assets/images/blog/small/pic5.png'), 
	blogLarge1 : require('../assets/images/blog/large/pic1.png'), 
	//blog app images end
	
	//linkdin app images start
	bg1 : require('../assets/images/background/bg1.png'),
	bg2 : require('../assets/images/background/bg2.png'),
	bg3 : require('../assets/images/background/bg3.png'),
	bg4 : require('../assets/images/background/bg4.png'),
	bg5 : require('../assets/images/background/bg5.png'),
	logo1 : require('../assets/images/company/logo1.png'),
	logo2 : require('../assets/images/company/logo2.png'),
	logo3 : require('../assets/images/company/logo3.png'),
	logo4 : require('../assets/images/company/logo4.png'),
	postLinkdin1 : require('../assets/images/post/pic1.png'),
	postLinkdin2 : require('../assets/images/post/pic2.png'),
	postLinkdin3 : require('../assets/images/post/pic3.png'),
	postLinkdin4 : require('../assets/images/post/pic4.png'),
	//linkdin app images end

	//youtube app images start
	poster1 : require('../assets/images/poster/pic1.png'),
	poster2 : require('../assets/images/poster/pic2.png'),
	poster3 : require('../assets/images/poster/pic3.png'),
	poster4 : require('../assets/images/poster/pic4.png'),
	poster5 : require('../assets/images/poster/pic5.png'),
	poster6 : require('../assets/images/poster/pic6.png'),
	poster7 : require('../assets/images/poster/vertical/pic1.png'),
	poster8 : require('../assets/images/poster/vertical/pic2.png'),
	poster9 : require('../assets/images/poster/vertical/pic3.png'),
	youtubeProfile1 : require('../assets/images/profile/pic1.png'),
	youtubeProfile2 : require('../assets/images/profile/pic2.png'),
	youtubeProfile3 : require('../assets/images/profile/pic3.png'),
	youtubeProfile4 : require('../assets/images/profile/pic4.png'),
